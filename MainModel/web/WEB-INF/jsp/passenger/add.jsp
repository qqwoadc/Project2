		     ...
		     <div class="span3">
		        ...
		        <select name="genderID" style="width:100%;height:27px;">
		            <c:forEach items="${listGender}" var="item">
			          <option value="${item.attributeDetailsName}" <c:if test="${item.far_id==31}">selected="selected"</c:if>>
		        ...
		        <label>民族：</label>
		         <select name="nationID" style="width:100%;height:27px;">
		            <c:forEach items="${listNation}" var="item">
			          <option value="${item.attributeDetailsName}" <c:if test="${item.far_id==33}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>文化程度：</label>
		         <select name="educationDegreeID" style="width:100%;height:27px;">
		            <c:forEach items="${listEducationDegree}" var="item">
			          <option value="${item.attributeDetailsName}" <c:if test="${item.far_id==43}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		        ...
		        <label>旅客级别：</label>
		         <select name="passengerLevelID" style="width:100%;height:27px;">
		            <c:forEach items="${listPassengerLevel}" var="item">
			          <option value="${item.attributeDetailsName}" <c:if test="${item.far_id==52}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <select id="papersId" name="papersID" style="width:100%;height:27px;">
		            <c:forEach items="${listPapers}" var="item">
			          <option value="${item.attributeDetailsName}" <c:if test="${item.far_id==37}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
		     ...
		     <div class="span3">
		        ...
		        <select name="thingReasonID" style="width:100%;height:27px;">
		            <c:forEach items="${listThingReason}" var="item">
			          <option value="${item.attributeDetailsName}" <c:if test="${item.far_id==51}">selected="selected"</c:if>>
			            ${item.attributeDetailsName}
			          </option>
			        </c:forEach> 
		          </select>
