...
public class ReceiveTargetController {
    ...
    * */
    ...
    public String findReceiveTarget(Model model, String txtname, Integer currentPage) {
        ...
        if(null == txtname || txtname.isEmpty()){
            ...
            limit = 2;
            Page<ReceiveTarget> receiveTargetPage = service.searchPartPage(txtname, limit, currentPage);
    ...
    * */
    ...
    public String deleteReceiveTarget(/*int[] ids*/int id){

//        int i = service.deleteReceiveTargetByIds(ids);
