...
public class Financialstatisticsparticular {

    private String roomNumber;
    private String roomGuestRoomLevelName;
    private String receiveTeamName;
    private String receiveTeamCode;
    private String receivePrincipal;
    private String receiveTargetID;
    private String passengerName;
    private String passengerGenderName;
    private String passengerPapersName;
    private String passengerPapersNumber;
    private String pssengerContactPhoneNumber;
    ...
    private String roomStandardPriceDay;
    private String roomStandardPrice;
    private String roomFirstPrice;
    private String stayNumber;
    private String changRoomMoney;
    private float qiTaXiaoFei;
    private float yaJin;
    private float sumConst;
    private String predeterminePassengerName;
    ...
    public void setReceiveTargetID(String receiveTargetID) {
    ...
    public String getRoomStandardPriceDay() {
        return roomStandardPriceDay;
    }

    public void setRoomStandardPriceDay(String roomStandardPriceDay) {
    ...
    public void setRoomStandardPrice(String roomStandardPrice) {
        this.roomStandardPrice = roomStandardPrice;
    }

    public String getRoomFirstPrice() {
        return roomFirstPrice;
    }

    public void setRoomFirstPrice(String roomFirstPrice) {
    ...
    public String getChangRoomMoney() {
        return changRoomMoney;
    }

    public void setChangRoomMoney(String changRoomMoney) {
        this.changRoomMoney = changRoomMoney;
    }

    public float getQiTaXiaoFei() {
        return qiTaXiaoFei;
    }

    public void setQiTaXiaoFei(float qiTaXiaoFei) {
        this.qiTaXiaoFei = qiTaXiaoFei;
    }
    ...
    public void setPredeterminePassengerPapersNumber(String predeterminePassengerPapersNumber) {
    ...
    public void setPredeterminePassengerContactPhoneNumber(String predeterminePassengerContactPhoneNumber) {
    ...
    public String toString() {
        return "Financialstatisticsparticular{" +
                ...
                ", receiveTeamCode='" + receiveTeamCode + '\'' +
                ", receivePrincipal='" + receivePrincipal + '\'' +
                ", receiveTargetID='" + receiveTargetID + '\'' +
                ", passengerName='" + passengerName + '\'' +
                ", passengerGenderName='" + passengerGenderName + '\'' +
                ", passengerPapersName='" + passengerPapersName + '\'' +
                ", passengerPapersNumber='" + passengerPapersNumber + '\'' +
                ", pssengerContactPhoneNumber='" + pssengerContactPhoneNumber + '\'' +
                ...
                ", roomFirstPrice='" + roomFirstPrice + '\'' +
                ", stayNumber='" + stayNumber + '\'' +
                ", changRoomMoney='" + changRoomMoney + '\'' +
                ", qiTaXiaoFei=" + qiTaXiaoFei +
                ", yaJin=" + yaJin +
                ", sumConst=" + sumConst +
                ", predeterminePassengerName='" + predeterminePassengerName + '\'' +
                ", predeterminePassengerPapersNumber='" + predeterminePassengerPapersNumber + '\'' +
                ", predeterminePassengerContactPhoneNumber='" + predeterminePassengerContactPhoneNumber + '\'' +
                '}';
    }
}
